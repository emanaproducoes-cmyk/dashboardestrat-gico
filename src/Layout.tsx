...
export default function Layout({ children }: LayoutProps) {
  ...
  // BUG FIX: Properly type cloneElement props injection
      ...
      >
        ...
        <div className="px-2 pb-2 space-y-1">
          ...
          >
            <div
              ...
              style={{ background: accentGradient.css }}
            />
            {!collapsed && <span>Cores Globais</span>}
            {!collapsed && (
              <div className="ml-auto w-4 h-4 rounded-full" style={{ background: accentGradient.css }} />
            )}
          </button>
          <button
        ...
        {!collapsed && (
          <div className="p-4" style={{ borderTop: `1px solid ${sidebarBorder}` }}>
            <p className={`text-[10px] uppercase tracking-wider ${brandText1}`}>
              Planejamento Estratégico
            </p>
            <p className={`text-xs font-medium mt-0.5 ${brandText2}`}>
