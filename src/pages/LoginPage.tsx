...
export default function LoginPage() {
  ...
  const handleGoogle = async () => {
    ...
    if (!ok) setError("Não foi possível entrar com Google. Tente novamente.")
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="rounded-2xl p-8"
          ...
          <button onClick={handleGoogle} disabled={googleLoading}
            className="w-full flex items-center justify-center gap-3 py-3 rounded-xl text-white font-semibold text-sm transition-all duration-200 disabled:opacity-60 mb-4 hover:opacity-90"
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-xs text-white/30">ou use e-mail</span>
            <div className="flex-1 h-px" style={{ background: "rgba(255,255,255,0.1)" }} />
          </div>
