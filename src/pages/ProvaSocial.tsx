  ...
  return (
    <div className={bg}>
      ...
      <section>
        ...
        <p className={`${subClass} mb-5`}>Os pilares de diferenciação da AF Consultoria</p>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {brandItems.map((b, i) => (
            <div key={i} className={`rounded-xl border p-5 transition-all ${darkMode ? 'bg-white/10 border-white/10' : 'bg-white border-gray-100 shadow-sm'}`}>
              <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${b.color} flex items-center justify-center mb-4 text-3xl shadow-lg`}>
                {b.icon}
              </div>
      ...
      <section>
        ...
        <p className={`${subClass} mb-5`}>Rastreamento de novas aquisições — clique em "Ver" para detalhes</p>
        <div className={cardBg}>
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead>
