        ...
        <div className="flex items-center gap-4 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <h1 className="leading-tight">
              <EditableField value={companyName} onChange={setCompanyName} className="text-2xl font-extrabold text-white" />
            </h1>
            <p className="mt-1">
              <EditableField value={subtitle} onChange={setSubtitle} className="text-sm text-blue-100/80" />
            </p>
            <p className="mt-1 hidden md:block">
              <EditableField value={description} onChange={setDescription} className="text-xs text-blue-200/60 leading-relaxed" multiline />
            </p>
          </div>
        </div>
        ...
        {stats.map((s, i) => (
          <div key={i} className="md:flex-1 md:text-center px-4 first:pl-0">
            ...
            <p className="text-[11px] text-blue-200 mt-1">
              <EditableField value={s.label} onChange={v => updateStat(i, 'label', v)} className="text-[11px] text-blue-200" />
            </p>
          </div>
        ))}
      </div>
