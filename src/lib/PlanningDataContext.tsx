...
export const DEFAULT_PLANNING_DATA: PlanningData = {
  empresa: {
    nome: "", segmento: "", cnpj: "", responsavel: "",
    cargo: "", email: "", periodo: "", versao: "v1.0"
  },
  missaoVisao: {
  ...
  acoes: [
    { id: "ac1", iniciativa: "", objetivo: "", porque: "", responsavel: "", area: "", dataInicio: "", dataFim: "", onde: "", como: "", orcamento: "", prioridade: "Alta", status: "Não iniciado" }
  ],
  orcamento: {
    receitas: [
  ...
  riscos: [
    { id: "ri1", risco: "", categoria: "", descricao: "", probabilidade: 1, impacto: 1, mitigacao: "", responsavel: "", prazo: "", status: "Ativo" }
  ],
  equipe: [
    { id: "eq1", nome: "", cargo: "", area: "", email: "", okrPrincipal: "", kpiResponsavel: "", nivel: "Pleno", status: "Ativo" }
  ],
  acompanhamento: {
    q1: { ...EMPTY_REVISAO },
    q2: { ...EMPTY_REVISAO },
