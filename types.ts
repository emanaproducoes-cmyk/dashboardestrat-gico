...
const channels: Channel[] = [
  {
    ...
    meta: "+200 seguidores | 2.5–5.5% engajamento",
    tags: ["B2B", "Autoridade", "Longo prazo"],
    modalSection: {
      title: "Estratégia LinkedIn",
      subtitle: "Canal principal de autoridade B2B",
      ...
      kpis: [
        { label: "Meta Seguidores", value: "+200" },
        { label: "Taxa Engajamento", value: "2.5–5.5%" },
        { label: "Posts/Semana", value: "3–4x" },
        { label: "Conversões/Ano", value: "28–32" },
      ],
      chart: {
        type: "bar",
        data: [
          { label: "Jan", Seguidores: 0 },
          { label: "Fev", Seguidores: 20 },
          { label: "Mar", Seguidores: 50 },
          { label: "Abr", Seguidores: 80 },
          { label: "Mai", Seguidores: 120 },
          { label: "Jun", Seguidores: 170 },
        ],
        colors: ["#3b82f6"]
      },
  ...
  },
  {
    ...
    meta: "+500 inscritos | 3.0–6.8% engajamento",
    tags: ["Educativo", "SEO", "Longo prazo"],
    modalSection: {
      title: "Estratégia YouTube",
      subtitle: "Canal de educação e SEO de longo prazo",
      ...
      kpis: [
        { label: "Meta Inscritos", value: "+500" },
        { label: "Taxa Engajamento", value: "3.0–6.8%" },
        { label: "Vídeos/Mês", value: "4–8" },
        { label: "Conversões/Ano", value: "43–56" },
      ],
      chart: {
        type: "area",
        data: [
          { month: "Jan", Inscritos: 0, Visualizações: 0 },
          { month: "Fev", Inscritos: 12, Visualizações: 150 },
          { month: "Mar", Inscritos: 30, Visualizações: 420 },
          { month: "Abr", Inscritos: 50, Visualizações: 680 },
          { month: "Mai", Inscritos: 80, Visualizações: 1100 },
          { month: "Jun", Inscritos: 100, Visualizações: 1500 },
        ],
  ...
  },
  {
    ...
    meta: "70–105 conversões | Awareness regional",
    tags: ["Awareness", "Social Proof", "Visual"],
    modalSection: {
      title: "Estratégia Instagram",
      subtitle: "Canal de conversão e prova social visual",
      description: "Instagram é o canal de maior alcance para o público geral e para conversões diretas através de DM e stories. Foco em resultados visuais e histórias de transformação.",
      kpis: [
        { label: "Conversões/Ano", value: "70–105" },
        { label: "Posts/Semana", value: "4–6x" },
        { label: "Tipos de Conteúdo", value: "5 tipos" },
        { label: "Formato Principal", value: "Reels" },
      ],
      chart: {
        type: "pie",
        data: [
          { name: "Antes/Depois", value: 40, color: "#ec4899" },
          { name: "Vídeos/Reels", value: 30, color: "#8b5cf6" },
          { name: "Reposts", value: 20, color: "#f59e0b" },
          { name: "Bastidores", value: 10, color: "#06b6d4" },
        ]
      },
  ...
  },
  {
    ...
    meta: "SEO orgânico | Referência técnica",
    tags: ["SEO", "Técnico", "Longo prazo"],
    modalSection: {
      title: "Estratégia Blog / Website",
      subtitle: "Canal de SEO e referência técnica",
      description: "O blog é a base de SEO de longo prazo da AF, com conteúdo técnico aprofundado sobre FNO, BNDES e projetos econômicos. Em H2, será o lar das Histórias que Transformam.",
      kpis: [
        { label: "Posts/Mês", value: "1–2" },
        { label: "Foco", value: "SEO" },
        { label: "Lançamento H2", value: "Jul/26" },
        { label: "Sessão/mês Alvo", value: "+500" },
      ],
      bullets: [
        "Artigos técnicos sobre linhas de crédito FNO e BNDES",
        "Análises de mercado e tendências do setor",
        "Seção 'Histórias que Transformam' com cases publicados em H2",
        "Glossário de termos técnicos para decisores",
        "Páginas de serviço otimizadas para SEO local"
      ],
...
export default function Canais({ darkMode = false, accentGradient }: PageProps) {
  // BUG FIX: typed state for activeModal
  ...
  return (
    <div className={bg}>
      ...
      <section>
        <h2 className={`${titleClass} mb-1`}>Mix de Canais por Semestre</h2>
        <p className={`${subClass} mb-5`}>Estratégia de conteúdo H1 (Jan–Jun) e H2 (Jul–Dez)</p>
            ...
            >
              <div className="flex items-center gap-3 mb-5">
                ...
                <div className="min-w-0">
                  ...
                  <p className={`text-xs truncate ${subClass}`}>{ch.meta}</p>
                </div>
                  ...
                  <div key={label} className={`rounded-xl p-3 ${labelBg}`}>
                    ...
                    <div className="space-y-1">
                      <div className="flex gap-2 text-xs">
                        <span className={darkMode ? 'text-white/30' : 'text-gray-400'}>Freq.:</span>
                        <span className={`font-medium ${valClass}`}>{data.freq}</span>
                      </div>
                      <div className="flex gap-2 text-xs">
                        <span className={darkMode ? 'text-white/30' : 'text-gray-400'}>Formato:</span>
                        <span className={`font-medium ${valClass}`}>{data.format}</span>
                      </div>
                      <div className="flex gap-2 text-xs">
                        <span className={darkMode ? 'text-white/30' : 'text-gray-400'}>Linguagem:</span>
                        <span className={`font-medium ${valClass}`}>{data.lang}</span>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="flex flex-wrap gap-1.5 mt-4">
                {ch.tags.map(t => (
                  <span key={t} className={`text-[10px] px-2 py-0.5 rounded-full ${tagClass}`}>{t}</span>
                ))}
              </div>
            </button>
          ))}
      ...
      <section className={sectionBg}>
        <h2 className={`${titleClass} mb-1`}>Crescimento de Seguidores</h2>
        <p className={`${subClass} mb-5`}>Evolução projetada para 2026</p>
      ...
      {activeModal && (
        <SectionDetailModal
          ...
          section={activeModal.modalSection}
        />
      )}
    </div>
  )
